...
class PasswordFormActivity : AppCompatActivity() {
	...
	private fun checkFormValidation(): Boolean {
		...
		if (appName.isEmpty()) {
			...
			binding.tilAppName.error = "This field must not be empty!"
		} else {
		...
		if (email.isEmpty()) {
			...
			binding.tilEmail.error = "This field must not be empty!"
		} else {
		...
		if (username.isEmpty()) {
			...
			binding.tilUsername.error = "This field must not be empty!"
		} else {
		...
		if (password.isEmpty()) {
			...
			binding.tilPassword.error = "This field must not be empty!"
		} else {
